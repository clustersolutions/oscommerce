 ...
 */
    ...
    protected $_life_time = SERVICE_SESSION_EXPIRATION_TIME; // HPDL for Shop, use setLifeTime() method
...
/**
 * Sets the life time of the session
 *
 * @param int $time The life time of the session (in minutes)
 * @access public
 */
