...
*/
  ...
  define('BREADCRUMB_SEARCH', 'Search');
  define('BREADCRUMB_SEARCH_RESULTS', 'Results');

  define('HEADING_TITLE_SEARCH', 'Search');
  define('HEADING_TITLE_SEARCH_RESULTS', 'Search Results');

  define('TEXT_SEARCH_CRITERIA', 'Search Criteria');
