...
*/
  ...
  define('NAVBAR_TITLE_MY_ORDERS', 'Orders');
  define('NAVBAR_TITLE_ORDER_INFORMATION', 'Order #%s');
  define('NAVBAR_TITLE_NEWSLETTERS', 'Newsletters');
  define('NAVBAR_TITLE_NOTIFICATIONS', 'Notifications');
  define('NAVBAR_TITLE_ADDRESS_BOOK', 'Address Book');
  define('NAVBAR_TITLE_ADDRESS_BOOK_ADD_ENTRY', 'Add Entry');
  ...
  define('HEADING_TITLE_ORDER_INFORMATION', 'Order #%s');
  define('HEADING_TITLE_NEWSLETTERS', 'My Newsletter Subscriptions');
  define('HEADING_TITLE_NOTIFICATIONS', 'My Product Notifications');
  define('HEADING_TITLE_ADDRESS_BOOK', 'My Address Book');
  ...
  define('MY_EMAIL_NOTIFICATIONS_TITLE', 'E-Mail Notifications');
  define('MY_EMAIL_NOTIFICATIONS_NEWSLETTERS', 'Subscribe or unsubscribe from newsletters.');
  define('MY_EMAIL_NOTIFICATIONS_PRODUCTS', 'View or change my product notification list.');
  ...
  define('SUCCESS_PASSWORD_UPDATED', 'Your account password has been successfully updated.');
  ...
  define('ERROR_CURRENT_PASSWORD_NOT_MATCHING', 'Your current password does not match our records. Please try again.');
