...
*/
  ...
  define('NAVBAR_TITLE_MY_ORDERS', 'Bestellungen');
  define('NAVBAR_TITLE_ORDER_INFORMATION', 'Bestellnummer %s');
  define('NAVBAR_TITLE_NEWSLETTERS', 'Newsletter Abonnements');
  define('NAVBAR_TITLE_NOTIFICATIONS', 'Produktbenachrichtungen');
  define('NAVBAR_TITLE_ADDRESS_BOOK', 'Adressbuch');
  ...
  define('HEADING_TITLE_ORDERS', 'Ihre get&auml;tigten Bestellungen');
  define('HEADING_TITLE_ORDER_INFORMATION', 'Bestellnummer %s');
  define('HEADING_TITLE_NEWSLETTERS', 'Newsletter Abonnements');
  define('HEADING_TITLE_NOTIFICATIONS', 'Produktbenachrichtungen');
  define('HEADING_TITLE_ADDRESS_BOOK', 'Mein Pers&ouml;nliches Adressbuch');
  ...
  define('MY_EMAIL_NOTIFICATIONS_TITLE', 'E-Mail Benachrichtigungen');
  define('MY_EMAIL_NOTIFICATIONS_NEWSLETTERS', 'Newsletter abonnieren oder abbestellen.');
  define('MY_EMAIL_NOTIFICATIONS_PRODUCTS', 'Meine Produktbenachrichtigungen anzeigen oder &auml;ndern.');
  ...
  define('NEW_ADDRESS_TITLE', 'Neuer Adressbuch Eintrag');
