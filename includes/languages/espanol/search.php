...
*/
  ...
  define('BREADCRUMB_SEARCH', 'B&uacute;squeda Avanzada');
  define('BREADCRUMB_SEARCH_RESULTS', 'Resultados de la B&uacute;squeda');

  define('HEADING_TITLE_SEARCH', 'B&uacute;squeda Avanzada');
  define('HEADING_TITLE_SEARCH_RESULTS', 'Productos que satisfacen los criterios de b&uacute;squeda');

  define('TEXT_SEARCH_CRITERIA', 'B&uacute;squeda Avanzada');
