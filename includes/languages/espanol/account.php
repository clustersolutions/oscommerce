...
*/
  ...
  define('NAVBAR_TITLE_MY_ORDERS', 'Pedidos');
  define('NAVBAR_TITLE_ORDER_INFORMATION', 'Pedido #%s');
  define('NAVBAR_TITLE_NEWSLETTERS', 'Subscripci&oacute;n a Boletines');
  define('NAVBAR_TITLE_NOTIFICATIONS', 'Avisos de Productos');
  define('NAVBAR_TITLE_ADDRESS_BOOK', 'Direcciones');
  define('NAVBAR_TITLE_ADDRESS_BOOK_ADD_ENTRY', 'Nueva Direcci&oacute;n');
  ...
  define('HEADING_TITLE_ORDERS', 'Mi Pedidos');
  define('HEADING_TITLE_ORDER_INFORMATION', 'Pedido #%s');
  define('HEADING_TITLE_NEWSLETTERS', 'Subscripci&oacute;n a Boletines');
  define('HEADING_TITLE_NOTIFICATIONS', 'Avisos de Productos');
  define('HEADING_TITLE_ADDRESS_BOOK', 'Mis Direcciones Postales');
  ...
  define('MY_EMAIL_NOTIFICATIONS_TITLE', 'Notificaciones por E-Mail');
  define('MY_EMAIL_NOTIFICATIONS_NEWSLETTERS', 'Subscribirse or no a los boletines.');
  define('MY_EMAIL_NOTIFICATIONS_PRODUCTS', 'Ver o modificar mis notificaciones de productos.');
