<?php
/*
  $Id: login.php 21 2005-03-03 01:55:46Z hpdl $
    ...
    <td width="50%" valign="top">
      <div class="moduleBox">
        ...
        <div class="content">
          ...
          <p align="right"><?php echo '<a href="' . tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL') . '">' . tep_image_button('button_continue.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></p>
        </div>
      </div>
    </td>
    <td width="50%" valign="top">
      ...
      <div class="moduleBox">
        ...
        <div class="content">
          ...
          <p><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . TEXT_LOGIN_PASSWORD_FORGOTTEN . '</a>'; ?></p>
