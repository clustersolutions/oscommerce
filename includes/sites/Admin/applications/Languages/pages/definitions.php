...
<form id="liveSearchForm">
  ...
  <span style="float: right;"><?php echo osc_draw_button(array('href' => OSCOM::getLink(null, null, 'id=' . $_GET['id']), 'icon' => 'triangle-1-w', 'title' => __('button_back'))) . ' ' . osc_draw_button(array('href' => OSCOM::getLink(null, null, 'id=' . $_GET['id'] . '&group=' . $_GET['group'] . '&action=InsertDefinition'), 'icon' => 'plus', 'title' => __('button_insert'))); ?></span>
</form>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="defsDataTable">
  <thead>
    <tr>
      <th><?php echo __('table_heading_key'); ?></th>
...
<script type="text/javascript"><!--
  ...
  var dataTableDataURL = '<?php echo OSCOM::getLink('RPC', null, 'id=' . $_GET['id'] . '&group=' . $_GET['group'] . '&action=getDefinitions'); ?>';
