...
<div class="infoBox">
  <h3><?php echo osc_icon('trash.png') . ' ' . __('action_heading_batch_delete_languages'); ?></h3>

  <form name="lDeleteBatch" class="dataForm" action="<?php echo OSCOM::getLink(null, null, 'action=BatchDelete'); ?>" method="post">

  <p><?php echo __('introduction_batch_delete_languages'); ?></p>
...
<?php
  ...
  if ( $check_default_flag === false ) {
    ...
    echo '<p><b>' . __('introduction_delete_language_invalid') . '</b></p>';
