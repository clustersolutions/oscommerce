...
<table border="0" width="100%" cellspacing="0" cellpadding="2" class="dataTable" id="administratorsDataTable">
  <thead>
    <tr>
      <th><?php echo __('table_heading_administrators'); ?></th>
...
<script type="text/javascript"><!--
  ...
  var adminEditLink = '<?php echo OSCOM::getLink(null, null, 'id=ADMINID&action=Save'); ?>';
  var adminEditLinkIcon = '<?php echo osc_icon('edit.png'); ?>';

  var adminDeleteLink = '<?php echo OSCOM::getLink(null, null, 'id=ADMINID&action=Delete'); ?>';
