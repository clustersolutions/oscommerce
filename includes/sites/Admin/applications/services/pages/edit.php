...
<div class="infoBoxHeading"><?php echo osc_icon('edit.png') . ' ' . $module->title; ?></div>
<div class="infoBoxContent">
  <form name="mEdit" action="<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&module=' . $_GET['module'] . '&action=save'); ?>" method="post">

  <p><?php echo $osC_Language->get('introduction_edit_service_module'); ?></p>
