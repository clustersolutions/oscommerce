...
<script type="text/javascript">
  ...
  var classEditLink = '<?php echo OSCOM::getLink(null, null, 'id=CLASSID&action=Save'); ?>';
  var classEditLinkIcon = '<?php echo osc_icon('edit.png'); ?>';

  var classDeleteLink = '<?php echo OSCOM::getLink(null, null, 'id=CLASSID&action=Delete'); ?>';
  ...
  function feedDataTable(data) {
    ...
    for ( var r in data.entries ) {
      ...
      $('#row' + parseInt(record.tax_class_id)).hover( function() { rowOverEffect(this); }, function() { rowOutEffect(this); }).click(function(event) {
