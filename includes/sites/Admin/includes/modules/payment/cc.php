<?php
/*
  $Id: cc.php 743 2006-08-22 18:25:36Z hpdl $
 ...
 */
  ...
  class osC_Payment_cc extends osC_Payment_Admin {
 ...
 */
    ...
    function osC_Payment_cc() {
      ...
      $this->_status = (defined('MODULE_PAYMENT_CC_STATUS') && (MODULE_PAYMENT_CC_STATUS == '1') ? true : false);
 ...
 */
    ...
    function isInstalled() {
      return (bool)defined('MODULE_PAYMENT_CC_STATUS');
    }
 ...
 */
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Enable Credit Card Module', 'MODULE_PAYMENT_CC_STATUS', '-1', 'Do you want to accept credit card payments?', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Credit Cards', 'MODULE_PAYMENT_CC_ACCEPTED_TYPES', '', 'Accept these credit card types for this payment method.', '6', '0', 'osc_cfg_set_credit_cards_checkbox_field', now())");
    ...
    function getKeys() {
      if (!isset($this->_keys)) {
        $this->_keys = array('MODULE_PAYMENT_CC_STATUS',
                             ...
                             'MODULE_PAYMENT_CC_ACCEPTED_TYPES',
