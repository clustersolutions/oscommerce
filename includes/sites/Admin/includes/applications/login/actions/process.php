  ...
  class osC_Application_Login_Actions_process extends osC_Application_Login {
    public function __construct() {
      ...
      if ( !empty($_POST['user_name']) && !empty($_POST['user_password']) ) {
        $Qadmin = $osC_Database->query('select id, user_name, user_password from :table_administrators where user_name = :user_name limit 1');
      ...
      $osC_MessageStack->add('header', __('ms_error_login_invalid'), 'error');
    }
  }
?>
