...
<h1><?php echo osc_icon('administrators.png', $osC_Template->getPageTitle(), '32x32') . osc_link_object(osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule()), $osC_Template->getPageTitle()); ?></h1>
...
<div>
  ...
  <span style="float: right;"><?php echo osc_draw_button(array('href' => osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&action=save'), 'icon' => 'plus', 'title' => $osC_Language->get('button_insert'))); ?></span>
</div>
...
<script type="text/javascript"><!--
  ...
  var adminEditLink = '<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&aID=ADMINID&action=save'); ?>';
  var adminEditLinkIcon = '<?php echo osc_icon('edit.png'); ?>';

  var adminDeleteLink = '<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&aID=ADMINID&action=delete'); ?>';
  var adminDeleteLinkIcon = '<?php echo osc_icon('trash.png'); ?>';
