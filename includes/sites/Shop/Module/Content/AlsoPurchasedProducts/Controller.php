...
*/
  ...
  namespace osCommerce\OM\Site\Shop\Module\Content\AlsoPurchasedProducts;
      ...
      if ( Registry::exists('Product') ) {
        ...
        if ( $Qorders->numberOfRows() >= MODULE_CONTENT_ALSO_PURCHASED_MIN_DISPLAY ) {
          ...
          while ( $Qorders->next() ) {
            ...
            $this->_content .= osc_link_object(OSCOM::getLink(null, 'Products', $Qorders->value('products_keyword')), $Qorders->value('products_name')) .
                               '</span>';
          }
