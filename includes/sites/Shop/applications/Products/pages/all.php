...
?>
    ...
    <td align="right" valign="middle"><?php echo osc_link_object(OSCOM::getLink(null, null, $OSCOM_Product->getKeyword() . '&action=cart_add'), osc_draw_image_button('button_in_cart.gif', OSCOM::getDef('button_add_to_cart'))); ?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
