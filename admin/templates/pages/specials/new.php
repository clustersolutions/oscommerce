...
<div class="infoBoxHeading"><?php echo osc_icon('new.png', IMAGE_INSERT) . ' ' . TEXT_HEADING_NEW_SPECIAL; ?></div>
<div class="infoBoxContent">
  ...
  <p><?php echo TEXT_SPECIALS_PRODUCT . '<br />' . osc_draw_pull_down_menu('products_id', $specials_array); ?></p>
  <p><?php echo TEXT_SPECIALS_SPECIAL_PRICE_NET . '<br />' . osc_draw_input_field('specials_price', null, 'onkeyup="updateGross(\'specials_price\', event)"'); ?></p>
  <p><?php echo TEXT_SPECIALS_SPECIAL_PRICE_GROSS . '<br />' . osc_draw_input_field('specials_price_gross', null, 'onkeyup="updateNet(\'specials_price\', event)"'); ?></p>
  <p><?php echo TEXT_SPECIALS_STATUS . '<br />' . osc_draw_checkbox_field('specials_status', '1', null); ?></p>
  <p><?php echo TEXT_SPECIALS_START_DATE . '<br />' . osc_draw_input_field('specials_start_date', null) . '<input type="button" value="..." id="calendarTriggerStartDate" class="operationButton"><script type="text/javascript">Calendar.setup( { inputField: "specials_start_date", ifFormat: "%Y-%m-%d", button: "calendarTriggerStartDate" } );</script>'; ?></p>
  <p><?php echo TEXT_SPECIALS_EXPIRES_DATE . '<br />' . osc_draw_input_field('specials_expires_date', null) . '<input type="button" value="..." id="calendarTriggerEndDate" class="operationButton"><script type="text/javascript">Calendar.setup( { inputField: "specials_expires_date", ifFormat: "%Y-%m-%d", button: "calendarTriggerEndDate" } );</script>'; ?></p>
