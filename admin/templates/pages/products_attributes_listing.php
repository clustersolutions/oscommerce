...
<?php
  foreach ($osC_Language->getAll() as $l) {
    echo tep_image('../includes/languages/' . $l['code'] . '/images/icon.gif', $l['name']) . '&nbsp;' .  osc_draw_input_field('entry_name[' . $l['id'] . ']') . '<br />';
  }
?>
        </td>
      </tr>
...
<?php
    ...
    foreach ($osC_Language->getAll() as $l) {
      echo tep_image('../includes/languages/' . $l['code'] . '/images/icon.gif', $l['name']) . '&nbsp;' .  osc_draw_input_field('entry_name[' . $l['id'] . ']', (isset($entry_names[$l['id']]) ? $entry_names[$l['id']] : '')) . '<br />';
    }
?>
        </td>
      </tr>
