...
<div id="infoBox_lDefine">
  ...
  <div class="infoBoxContent">
    <form name="lDefine" action="<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '=' . $_GET[$osC_Template->getModule()] . '&group=' . $_GET['group'] . '&action=save_definition'); ?>" method="post">
...
?>
    ...
    <p align="center"><?php echo '<input type="submit" value="' . IMAGE_SAVE . '" class="operationButton"> <input type="button" value="' . IMAGE_CANCEL . '" onclick="document.location.href=\'' . osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '=' . $_GET[$osC_Template->getModule()] . '&group=' . $_GET['group']) . '\';" class="operationButton">'; ?></p>
