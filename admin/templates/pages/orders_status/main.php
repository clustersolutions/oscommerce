...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><?php echo $Qstatuses->displayBatchLinksTotal(TEXT_DISPLAY_NUMBER_OF_ENTRIES); ?></td>
    <td align="right"><?php echo $Qstatuses->displayBatchLinksPullDown('page', $osC_Template->getModule()); ?></td>
  </tr>
</table>
