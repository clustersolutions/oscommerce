...
<div class="infoBoxContent">
  <form name="cDelete" action="<?php echo osc_href_link(FILENAME_DEFAULT, $osC_Template->getModule() . '&page=' . $_GET['page'] . '&cID=' . $osC_ObjectInfo->get('countries_id') . '&action=delete'); ?>" method="post">
