...
<div class="infoBoxHeading"><?php echo osc_icon('configure.png', IMAGE_EDIT) . ' ' . osc_output_string_protected(osC_Customers_Admin::getData($_GET['cID'], 'customers_firstname')) . ' ' . osc_output_string_protected(osC_Customers_Admin::getData($_GET['cID'], 'customers_lastname')); ?></div>
