...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><?php echo $Qnewsletters->displayBatchLinksTotal(TEXT_DISPLAY_NUMBER_OF_ENTRIES); ?></td>
    <td align="right"><?php echo $Qnewsletters->displayBatchLinksPullDown('page', $osC_Template->getModule()); ?></td>
  </tr>
</table>
