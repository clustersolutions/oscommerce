...
*/
  ...
  class osC_Content_Products_attributes extends osC_Template {
...
/* Class constructor */
    ...
    function osC_Content_Products_attributes() {
      ...
      if (!empty($_GET[$this->_module]) && is_numeric($_GET[$this->_module])) {
        $this->_page_contents = 'products_attributes_listing.php';
      }
...
/* Private methods */
    ...
    function _save() {
      ...
      osc_redirect(osc_href_link_admin(FILENAME_DEFAULT, $this->_module . '&page=' . $_GET['page'] . '&paID=' . $group_id));
    }
    ...
    function _saveEntry() {
      ...
      if ($error === false) {
        if (!isset($_GET['paeID'])) {
          ...
          $Qlink->bindInt(':products_options_id', $_GET[$this->_module]);
      ...
      osc_redirect(osc_href_link_admin(FILENAME_DEFAULT, $this->_module . '=' . $_GET[$this->_module] . '&page=' . $_GET['page'] . '&entriesPage=' . $_GET['entriesPage'] . '&paeID=' . $entry_id));
    }
