...
/* Private methods */
    ...
    function _save() {
      global $osC_Database, $osC_Language, $osC_MessageStack, $cPath, $current_category_id;
      ...
      osc_redirect(osc_href_link_admin(FILENAME_DEFAULT, $this->_module . '&page=' . $_GET['page'] . '&cPath=' . $cPath . '&cID=' . $category_id));
    }

    function _delete() {
      global $osC_Database, $osC_MessageStack, $osC_CategoryTree, $cPath;
      ...
      osc_redirect(osc_href_link_admin(FILENAME_DEFAULT, $this->_module . '&page=' . $_GET['page'] . '&cPath=' . $cPath . '&search=' . $_GET['search']));
    }

    function _move() {
      global $osC_Database, $osC_MessageStack, $cPath;
      ...
      osc_redirect(osc_href_link_admin(FILENAME_DEFAULT, $this->_module . '&page=' . $_GET['page'] . '&cPath=' . $cPath . '&search=' . $_GET['search'] . '&cID=' . $_GET['cID']));
    }
  }
?>
