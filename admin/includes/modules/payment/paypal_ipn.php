...
*/
  ...
  class osC_Payment_paypal_ipn extends osC_Payment_Admin {
    var $_title,
        $_code = 'paypal_ipn',
    ...
    function osC_Payment_paypal_ipn() {
      global $osC_Language;

      $this->_title = $osC_Language->get('payment_paypal_ipn_title');
      $this->_description = $osC_Language->get('payment_paypal_ipn_description');
      $this->_method_title = $osC_Language->get('payment_paypal_ipn_method_title');
    ...
    function isInstalled() {
      return defined('MODULE_PAYMENT_PAYPAL_IPN_STATUS');
    }
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('API Username', 'MODULE_PAYMENT_PAYPAL_IPN_API_USERNAME', '', 'The seller e-mail address to use for accepting PayPal payments.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('API Password', 'MODULE_PAYMENT_PAYPAL_IPN_API_PASSWORD', '', 'The seller e-mail address to use for accepting PayPal payments.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('API Certificate', 'MODULE_PAYMENT_PAYPAL_IPN_API_CERTIFICATE', '', 'The seller e-mail address to use for accepting PayPal payments.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Enable Encrypted Web Payments', 'MODULE_PAYMENT_PAYPAL_IPN_EWP_STATUS', '-1', 'Do you want to enable Encrypted Web Payments?', '6', '0', 'osc_cfg_get_boolean_value', 'tep_cfg_select_option(array(1, -1), ', now())");
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Currency', 'MODULE_PAYMENT_PAYPAL_IPN_CURRENCY', 'Selected Currency', 'The currency to use for credit card transactions', '6', '0', 'tep_cfg_select_option(array(\'Selected Currency\',\'USD\',\'CAD\',\'EUR\',\'GBP\',\'JPY\'), ', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'MODULE_PAYMENT_PAYPAL_IPN_SERVER', 'Sandbox', 'The server to perform transactions in.', '6', '0', 'tep_cfg_select_option(array(\'Production\',\'Sandbox\'), ', now())");
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, use_function, date_added) values ('Set Order Status', 'MODULE_PAYMENT_PAYPAL_IPN_ORDER_STATUS_ID', '0', 'Set the status of orders made with this payment module to this value', '6', '0', 'tep_cfg_pull_down_order_statuses(', 'tep_get_order_status_name', now())");
    }
    ...
    function getPostTransactionActions($history) {
      if ( (osc_empty(MODULE_PAYMENT_PAYPAL_IPN_API_USERNAME) === false) && (osc_empty(MODULE_PAYMENT_PAYPAL_IPN_API_PASSWORD) === false) && (osc_empty(MODULE_PAYMENT_PAYPAL_IPN_API_CERTIFICATE) === false) ) {
