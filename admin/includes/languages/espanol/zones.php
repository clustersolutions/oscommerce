<?php
/*
  $Id: zones.php,v 1.6 2004/07/22 22:31:57 hpdl Exp $
...
define('TABLE_HEADING_ZONE_CODE', 'C&oacute;digo');
define('TABLE_HEADING_ACTION', 'Acci&oacute;n');

define('TEXT_INFO_EDIT_INTRO', 'Haga los cambios necesarios');
define('TEXT_INFO_ZONES_NAME', 'Nombre de la Zona:');
define('TEXT_INFO_ZONES_CODE', 'C&oacute;digo de la Zona:');
define('TEXT_INFO_COUNTRY_NAME', 'Pa&iacute;s:');
