...
*/
  ...
  $module = 'osC_ProductAttributes_' . basename($_GET['module']);
  $module = new $module();
?>
...
<div class="infoBoxContent">
  <form name="mUninstall" action="<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&module=' . basename($_GET['module']) . '&action=uninstall'); ?>" method="post">

  <p><?php echo $osC_Language->get('introduction_uninstall_product_attribute_module'); ?></p>
