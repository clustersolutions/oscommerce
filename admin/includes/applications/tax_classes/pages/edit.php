...
*/
  ...
  $osC_ObjectInfo = new osC_ObjectInfo(osC_TaxClasses_Admin::getData($_GET['tcID']));
?>
...
<div class="infoBoxHeading"><?php echo osc_icon('edit.png') . ' ' . $osC_ObjectInfo->get('tax_class_title'); ?></div>
