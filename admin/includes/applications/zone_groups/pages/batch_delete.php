...
<div class="infoBoxContent">
  <form name="cDeleteBatch" class="dataForm" action="<?php echo osc_href_link_admin(FILENAME_DEFAULT, $osC_Template->getModule() . '&page=' . $_GET['page'] . '&action=batchDelete'); ?>" method="post">
...
<?php
  ...
  while ( $Qzones->next() ) {
    ...
    $zone_group_name = $Qzones->valueProtected('geo_zone_name');
