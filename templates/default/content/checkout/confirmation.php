...
?>
          <p><?php echo '<b>' . __('order_delivery_address_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'shipping&address', 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></p>
...
?>
          ...
          <p><?php echo '<b>' . __('order_shipping_method_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'shipping', 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></p>
...
?>
          ...
          <p><?php echo '<b>' . __('order_billing_address_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'billing&address', 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></p>
          <p><?php echo osC_Address::format($osC_ShoppingCart->getBillingAddress(), '<br />'); ?></p>

          <p><?php echo '<b>' . __('order_payment_method_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'billing', 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></p>
...
?>
              ...
              <tr>
                <td colspan="2"><?php echo '<b>' . __('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null, 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></td>
                <td align="right"><b><?php echo __('order_tax_title'); ?></b></td>
                <td align="right"><b><?php echo __('order_total_title'); ?></b></td>
              </tr>
...
?>
              ...
              <tr>
                <td colspan="3"><?php echo '<b>' . __('order_products_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, null, 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></td>
              </tr>
...
<div class="moduleBox">
  <h6><?php echo __('order_payment_information_title'); ?></h6>
...
<div class="moduleBox">
  <h6><?php echo '<b>' . __('order_comments_title') . '</b> ' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'payment', 'SSL'), '<span class="orderEdit">' . __('order_text_edit_title') . '</span>'); ?></h6>
...
<?php
  if ( $osC_Payment->hasActionURL() ) {
    ...
    $form_action_url = osc_href_link(FILENAME_CHECKOUT, 'confirmation=process', 'SSL');
  }
  ...
  echo osc_draw_image_submit_button('button_confirm_order.gif', __('button_confirm_order')) . '</form>';
?>
