...
<?php
  if ( $osC_MessageStack->exists('checkout_payment') ) {
    echo $osC_MessageStack->get('checkout_payment');
  }
?>

<form name="checkout_billing" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'billing', 'SSL'); ?>" method="post" onsubmit="return check_form();"><?php echo osc_draw_hidden_field('subaction', 'save'); ?>
...
<div class="moduleBox">
  <h6><?php echo __('order_conditions_title'); ?></h6>

  <div class="content">
    <?php echo sprintf(__('order_conditions_description'), osc_href_link(FILENAME_INFO, 'conditions', 'AUTO')) . '<br /><br />' . osc_draw_checkbox_field('conditions', array(array('id' => 1, 'text' => __('order_conditions_acknowledge'))), false); ?>
  </div>
</div>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <div style="float: right; padding: 0px 0px 10px 20px; text-align: center;">
      <?php echo '<b>' . __('billing_address_title') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?>
    </div>

    <?php echo __('choose_billing_destination'). '<br /><br />' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'billing&address', 'SSL'), osc_draw_image_button('button_change_address.gif', __('button_change_address'))); ?>
...
<div class="moduleBox">
  <h6><?php echo __('payment_method_title'); ?></h6>
...
?>
    ...
    <p style="margin-top: 0px;"><?php echo __('choose_payment_method'); ?></p>

<?php
  } else {
?>

    <p style="margin-top: 0px;"><?php echo __('only_one_payment_method_available'); ?></p>
...
<div class="moduleBox">
  <h6><?php echo __('add_comment_to_order_title'); ?></h6>
...
<div class="moduleBox">
  <div class="content">
    ...
    <?php echo '<b>' . __('continue_checkout_procedure_title') . '</b><br />' . __('continue_checkout_procedure_to_confirmation'); ?>
  </div>
</div>
