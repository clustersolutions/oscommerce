...
<form name="checkout_address" action="<?php echo osc_href_link(FILENAME_CHECKOUT, 'shipping&address=process', 'SSL'); ?>" method="post" onsubmit="return check_form_optional(checkout_address);">
...
<div class="moduleBox">
  <h6><?php echo __('shipping_address_title'); ?></h6>
  ...
  <div class="content">
    ...
    <div style="float: right; padding: 0px 0px 10px 20px; text-align: center;">
      <?php echo '<b>' . __('current_shipping_address_title') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_south_east.gif'); ?>
    </div>

    <?php echo __('selected_shipping_destination'); ?>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <p style="margin-top: 0px;"><?php echo __('select_another_shipping_destination'); ?></p>
...
?>
            ...
            <td align="right"><?php echo osc_draw_radio_field('ab', $Qaddresses->valueInt('address_book_id'), (string)$osC_ShoppingCart->getShippingAddress('id')); ?></td>
            <td width="10">&nbsp;</td>
          </tr>
          <tr>
            <td width="10">&nbsp;</td>
...
<div class="moduleBox">
  <h6><?php echo __('new_shipping_address_title'); ?></h6>

  <div class="content">
    <?php echo __('new_shipping_address'); ?>
...
<div class="moduleBox">
  <div class="content">
    ...
    <?php echo '<b>' . __('continue_checkout_procedure_title') . '</b><br />' . __('continue_checkout_procedure_to_shipping'); ?>
  </div>
</div>
