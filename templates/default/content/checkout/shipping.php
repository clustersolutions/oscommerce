...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <?php echo __('choose_shipping_destination'). '<br /><br />' . osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'shipping&address', 'SSL'), osc_draw_image_button('button_change_address.gif', __('button_change_address'))); ?>
...
<div class="moduleBox">
  <h6><?php echo __('shipping_method_title'); ?></h6>
...
?>
    ...
    <p style="margin-top: 0px;"><?php echo __('choose_shipping_method'); ?></p>

<?php
    } else {
?>

    <p style="margin-top: 0px;"><?php echo __('only_one_shipping_method_available'); ?></p>
