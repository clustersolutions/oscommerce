 ...
 */
    ...
    function osC_Payment_authorizenet_echeck() {
      ...
      $this->_description = $osC_Language->get('payment_authorizenet_echeck_description');
      $this->_method_title = $osC_Language->get('payment_authorizenet_echeck_method_title');
      $this->_status = (defined('MODULE_PAYMENT_AUTHORIZENET_ECHECK_STATUS') && (MODULE_PAYMENT_AUTHORIZENET_ECHECK_STATUS == '1') ? true : false);
      $this->_sort_order = (defined('MODULE_PAYMENT_AUTHORIZENET_ECHECK_SORT_ORDER') ? MODULE_PAYMENT_AUTHORIZENET_ECHECK_SORT_ORDER : null);

      if (defined('MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_SERVER')) {
 ...
 */
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Enable Authorize.net eCheck Module', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_STATUS', '-1', 'Do you want to accept Authorize.net eCheck payments?', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Login ID', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_LOGIN_ID', '', 'The Authorize.net account login ID.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Transaction Key', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_KEY', '', 'The transaction key obtained from the Merchant Interface.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('MD5 Hash Signature', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_MD5_HASH', '', 'The MD5 hash value to verify the results of a transaction.', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Verify With Wells Fargo SecureSource', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_VERIFY_WITH_WF_SS', '-1', 'Verify transactions with the customers tax ID (or SSN) through Wells Fargo SecureSource.', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Transaction Server', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_SERVER', 'test', 'Perform transactions on the production server or on the testing server.', '6', '0', 'osc_cfg_set_boolean_value(array(\'production\', \'certification\', \'test\'))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('Transaction Mode', 'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_TEST_MODE', '-1', 'Perform test transactions only.', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    ...
    function getKeys() {
      if (!isset($this->_keys)) {
        $this->_keys = array('MODULE_PAYMENT_AUTHORIZENET_ECHECK_STATUS',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_LOGIN_ID',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_KEY',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_MD5_HASH',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_VERIFY_WITH_WF_SS',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_SERVER',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_TRANSACTION_TEST_MODE',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_ZONE',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_ORDER_STATUS_ID',
                             'MODULE_PAYMENT_AUTHORIZENET_ECHECK_SORT_ORDER');
      }
        ...
        if (empty($result) === false) {
          ...
          if ($transaction_return_status == '1') {
            if (!osc_empty(MODULE_PAYMENT_AUTHORIZENET_ECHECK_MD5_HASH)) {
              if ($regs[37] != strtoupper(md5(MODULE_PAYMENT_AUTHORIZENET_ECHECK_MD5_HASH . MODULE_PAYMENT_AUTHORIZENET_ECHECK_LOGIN_ID . $inquiry_regs[6] . $inquiry_regs[9]))) {
