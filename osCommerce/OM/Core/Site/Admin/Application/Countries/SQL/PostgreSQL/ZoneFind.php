 ...
 */
  ...
  class ZoneFind {
    public static function execute($data) {
      ...
      $Qzones = $OSCOM_PDO->prepare('select * from :table_zones where zone_country_id = :zone_country_id and (zone_name ilike :zone_name or zone_code ilike :zone_code) order by zone_name');
