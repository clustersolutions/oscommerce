 ...
 */
  ...
  namespace osCommerce\OM\Core\Site\Admin\Application\Products\SQL\MySQL\Standard;
 ...
 */
  ...
  class GetAll {
    public static function execute($data) {
      ...
      $Qproducts->nextRowset();

      $result['total'] = $Qproducts->fetchColumn();
