...
#
# osCommerce, Harald Ponce de Leon 2005-01-22; Changed XML::parse() to always
# return $this->document and to ignore the first level of the tree. Removed calls
# to htmlspecialchars() from, and added CDATA checking to, XML_Serialize()
###################################################################################
